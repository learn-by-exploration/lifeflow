...
function renderDPBody(){
  ...
  $('dp-rec').addEventListener('change',()=>{
    ...
    const labels={daily:'Repeats every day',weekdays:'Repeats Mon–Fri',weekly:'Repeats every week','every-2-weeks':'Repeats every 2 weeks',monthly:'Repeats every month',yearly:'Repeats every year',custom:'Custom interval'};
