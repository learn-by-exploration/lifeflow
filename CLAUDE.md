...
> **Last updated:** 30 March 2026 · **Version:** 0.7.1
> **Metrics:** 2,036 tests | 87 test files | 190 API routes | 34 DB tables | ~15,000 LOC
...
npm test                    # 2,045 tests via node:test
# or with Docker:
docker compose up -d
```
...
- Current: 2,045 tests | 86 test files | 190 routes | 34 tables | ~15,000 LOC
